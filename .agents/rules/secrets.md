...
- Delete temp files holding secrets immediately (`shred -u`; on SSD/NTFS shred can't guarantee
  physical erasure — the point is: never leave the file behind). After changing a secret — redeploy.
